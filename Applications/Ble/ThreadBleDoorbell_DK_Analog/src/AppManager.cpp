...
/** @file "AppManager.cpp"
 *
 * Application logic for the QPG6200 Thread+BLE Doorbell DK Analog demo.
 *
 ...
 *
 * ── Analog doorbell (GPIO 29 / ANIO1, DK expansion header) ─────────────────
...
void AppManager::Init()
{
    ...
    GP_LOG_SYSTEM_PRINTF("============================================", 0);
    GP_LOG_SYSTEM_PRINTF("  QPG6200 THREAD+BLE DOORBELL DK ANALOG", 0);
    GP_LOG_SYSTEM_PRINTF("============================================", 0);
    GP_LOG_SYSTEM_PRINTF("Board  : QPG6200L Development Kit", 0);
    GP_LOG_SYSTEM_PRINTF("Button : ANIO1_GPI29 (GPIO 29, DK header)", 0);
    GP_LOG_SYSTEM_PRINTF("", 0);
    ...
    GP_LOG_SYSTEM_PRINTF("  Analog button on GPIO29/ANIO1 (DK header)", 0);
...
/* =========================================================================
 *  AnalogEventHandler  - GPADC doorbell on GPIO 29 / ANIO1
 * ========================================================================= */
...
void AppManager::RingDoorbell(bool fromThread, bool fromPhone)
{
    ...
    {
        GP_LOG_SYSTEM_PRINTF("#   Source: Local (GPIO29/ANIO1 analog button)", 0);
    }
    GP_LOG_SYSTEM_PRINTF("##############################################", 0);
    GP_LOG_SYSTEM_PRINTF("", 0);
