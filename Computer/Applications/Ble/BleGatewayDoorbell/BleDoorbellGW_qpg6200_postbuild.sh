...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/MemoryOverview/memoryoverview.py --logfile "${SCRIPT_DIR}"/../../../Work/BleDoorbellGW_qpg6200/BleDoorbellGW_qpg6200.memoryoverview --only-this "${SCRIPT_DIR}"/../../../Work/BleDoorbellGW_qpg6200/BleDoorbellGW_qpg6200.map
