...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/MemoryOverview/memoryoverview.py --logfile "${SCRIPT_DIR}"/../../../Work/BleIoTDemo_qpg6200/BleIoTDemo_qpg6200.memoryoverview --only-this "${SCRIPT_DIR}"/../../../Work/BleIoTDemo_qpg6200/BleIoTDemo_qpg6200.map
