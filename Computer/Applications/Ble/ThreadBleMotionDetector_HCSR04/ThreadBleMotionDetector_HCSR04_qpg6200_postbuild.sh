...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/MemoryOverview/memoryoverview.py \
    --logfile "${SCRIPT_DIR}"/../../../Work/ThreadBleMotionDetector_HCSR04_qpg6200/ThreadBleMotionDetector_HCSR04_qpg6200.memoryoverview \
    --only-this "${SCRIPT_DIR}"/../../../Work/ThreadBleMotionDetector_HCSR04_qpg6200/ThreadBleMotionDetector_HCSR04_qpg6200.map
