...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/MemoryOverview/memoryoverview.py \
    --logfile "${SCRIPT_DIR}"/../../../Work/ThreadBleMotionDetector_MaxSonar_qpg6200/ThreadBleMotionDetector_MaxSonar_qpg6200.memoryoverview \
    --only-this "${SCRIPT_DIR}"/../../../Work/ThreadBleMotionDetector_MaxSonar_qpg6200/ThreadBleMotionDetector_MaxSonar_qpg6200.map
