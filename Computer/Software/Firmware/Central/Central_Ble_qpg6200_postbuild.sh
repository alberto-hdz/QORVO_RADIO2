...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/MemoryOverview/memoryoverview.py --logfile "${SCRIPT_DIR}"/../../../Work/Peripheral_Ble_qpg6200/Peripheral_Ble_qpg6200.memoryoverview --only-this "${SCRIPT_DIR}"/../../../Work/Peripheral_Ble_qpg6200/Peripheral_Ble_qpg6200.map
