...
#define APP_TAMPER_BUTTON     PB3_BUTTON_GPIO_PIN
#define APP_CONTACT_SWITCH    SW_BUTTON_GPIO_PIN

// Mapping of LEDs
#define APP_STATE_LED          WHITE_COOL_LED_GPIO_PIN
#define APP_BLE_CONNECTION_LED BLUE_LED_GPIO_PIN
...
#define QPINCFG_BUTTONS QPINCFG_GPIO_LIST(APP_MULTI_FUNC_BUTTON, APP_TAMPER_BUTTON, APP_CONTACT_SWITCH)
...
#define QPINCFG_UNUSED                                                                                                 \
    QPINCFG_GPIO_LIST(PB1_BUTTON_GPIO_PIN, PB2_BUTTON_GPIO_PIN, PB4_BUTTON_GPIO_PIN, WHITE_WARM_LED_GPIO_PIN,          \
                      RED_LED_GPIO_PIN, GREEN_LED_GPIO_PIN, ANIO0_GPIO_PIN, EXT_32KXTAL_P, EXT_32KXTAL_N,              \
