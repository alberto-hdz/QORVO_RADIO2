...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/MemoryOverview/memoryoverview.py \
    --logfile "${SCRIPT_DIR}"/../../../Work/ThreadBleDoorbell_DK_qpg6200/ThreadBleDoorbell_DK_qpg6200.memoryoverview \
    --only-this "${SCRIPT_DIR}"/../../../Work/ThreadBleDoorbell_DK_qpg6200/ThreadBleDoorbell_DK_qpg6200.map
