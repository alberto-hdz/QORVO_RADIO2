...
/** @file "qorvo_config.h"
 *
 * Thread+BLE Doorbell DK application configuration.
 * Based on ThreadBleDoorbell_qpg6200 adapted for DK standalone operation (no carrier board).
 *
...
#define GP_VERSIONINFO_APP                                        ThreadBleDoorbell_DK_qpg6200
