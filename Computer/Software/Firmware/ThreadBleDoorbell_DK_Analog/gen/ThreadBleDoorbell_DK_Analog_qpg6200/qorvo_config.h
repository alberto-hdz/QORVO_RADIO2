...
/** @file "qorvo_config.h"
 *
 * Thread+BLE Doorbell DK Analog application configuration.
 * Based on BleDoorbell_qpg6200 with Thread (OpenThread) stack added.
 *
...
#define GP_VERSIONINFO_APP                                        ThreadBleDoorbell_DK_Analog_qpg6200
