...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/MemoryOverview/memoryoverview.py --logfile "${SCRIPT_DIR}"/../../../Work/BleDoorbell_qpg6200/BleDoorbell_qpg6200.memoryoverview --only-this "${SCRIPT_DIR}"/../../../Work/BleDoorbell_qpg6200/BleDoorbell_qpg6200.map
